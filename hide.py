...
input_image_filename = "logo.png"
output_icon_filename = "logo.ico"

# Open and convert the image to .ico format
img = Image.open(input_image_filename)
img.save(output_icon_filename, format="ICO")


root=Tk()
root.title("Steganography -Hide a Seceret Text Message in an Image")
